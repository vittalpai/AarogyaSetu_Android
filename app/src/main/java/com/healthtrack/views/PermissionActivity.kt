...
import com.healthtrack.utility.*
import com.healthtrack.utility.CorUtility.Companion.arePermissionsGranted
import com.healthtrack.utility.CorUtility.Companion.enableLocation
import com.healthtrack.utility.LocalizationUtil.getLocalisedString
import com.healthtrack.viewmodel.OnBoardingViewModel
...
class PermissionActivity : AppCompatActivity(), SelectLanguageFragment.LanguageChangeListener {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == BLUETOOTH_ENABLE_CODE) {
            configureLogin()
        } else if (requestCode == com.healthtrack.utility.LocationUtils.LOCATION_REQUEST) {
            configureLogin()
        }
    }
