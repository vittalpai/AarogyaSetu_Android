...
import com.healthtrack.analytics.ScreenNames
import com.healthtrack.background.BackgroundWorker
import com.healthtrack.background.BluetoothScanningService
import com.healthtrack.listener.QrCodeListener
import com.healthtrack.listener.QrPublicKeyListener
import com.healthtrack.models.BulkDataObject
import com.healthtrack.models.network.RegisterationData
import com.healthtrack.network.NetworkClient
import com.healthtrack.prefs.SharedPref
import com.healthtrack.prefs.SharedPrefsConstants
import com.healthtrack.views.HomeActivity
...
//            })
        ...
        fun refreshFCMToken(token: String) {
            ...
            val call = client.create(com.healthtrack.network.PostDataInterface::class.java)
                .refreshFCM(
                    getHeaders(false),
                    com.healthtrack.models.network.FCMTokenObject(token)
                )
        ...
        fun getNotificationChannel(): String {
            return com.healthtrack.utility.Constants.NOTIFICATION_CHANNEL
        }
        ...
        fun pushDataToServer(context: Context) {
            ...
            val workRequest = OneTimeWorkRequest.Builder(
                com.healthtrack.background.UploadDataToServerWorker::class.java
            ).build()
        ...
        fun remove30DaysOldData() {
            val dbInstance = com.healthtrack.db.FightCovidDB.getInstance()
